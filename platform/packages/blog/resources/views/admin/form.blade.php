    ...
    <x-admin-card title="Post content">
      <ul class="nav nav-tabs mb-3" role="tablist">
        <li class="nav-item" role="presentation">
          <button type="button" class="nav-link active" id="post-content-tab" data-bs-toggle="tab" data-bs-target="#post-content-pane" role="tab" aria-controls="post-content-pane" aria-selected="true">
            Content
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button type="button" class="nav-link" id="post-seo-tab" data-bs-toggle="tab" data-bs-target="#post-seo-pane" role="tab" aria-controls="post-seo-pane" aria-selected="false">
            SEO
          </button>
        </li>
      </ul>
      <div class="tab-content">
        <div class="tab-pane fade show active" id="post-content-pane" role="tabpanel" aria-labelledby="post-content-tab" tabindex="0">
          <x-admin-form-group
            name="title"
            label="Title"
            :value="$post->title"
        ...
        <div class="tab-pane fade" id="post-seo-pane" role="tabpanel" aria-labelledby="post-seo-tab" tabindex="0">
